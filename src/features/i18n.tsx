...
const ENGLISH = {
  ...
  comparisonDescription:
    "Compare two archives, or an archive and a folder, without changing either source.",
  comparisonJob: "Comparison",
  compareBaseline: "A — Baseline",
  compareTarget: "B — Comparison",
  archive: "Archive",
  folder: "Folder",
  chooseA: "Choose A",
  chooseB: "Choose B",
  compareAAndB: "Compare A and B",
  startingComparison: "Starting comparison…",
  comparisonStarted: "Comparison started",
  comparisonStartedHint:
    "The read-only comparison was added to the Job Center.",
  comparisonCompleted: "Comparison complete",
  comparisonCompletedHint:
    "The result is ready here and remains available in the Job Center.",
  comparisonDidNotComplete: "Comparison did not complete",
  comparisonDidNotCompleteHint:
    "Review the details below or retry the job from the Job Center.",
  comparisonReadOnlyHint:
    "Both sources are read only. Comparison never changes an archive or folder.",
  comparisonSourceRequired: "Choose both A and B before comparing.",
  comparisonSameSource: "Choose two different sources.",
  comparisonResults: "Comparison results",
  viewComparisonResults: "View comparison results",
  allDifferences: "All",
  differenceAdded: "Added",
  differenceRemoved: "Removed",
  differenceContentChanged: "Content changed",
  differenceMetadataChanged: "Metadata changed",
  differenceSame: "Same",
  differenceUnavailable: "Unavailable",
  differenceDetails: "Difference details",
  selectDifferenceHint: "Select an item to compare its A and B values.",
  sourceA: "Source A",
  sourceB: "Source B",
  contentHash: "Content hash",
  metadataDifferences: "Metadata differences",
  property: "Property",
  accessedAt: "Accessed",
  itemType: "Type",
  status: "Status",
  path: "Path",
  noDifferencesMatch: "No comparison items match this filter.",
  comparisonSearchPlaceholder: "Search paths",
  searchComparison: "Search comparison",
  comparisonLoadFailed: "The comparison results could not be loaded.",
  comparisonSourcePickerFailed: "The source could not be selected.",
  optionalArchivePassword: "Optional — only needed for encrypted archives.",
  ...
  jobSearchPlaceholder: "Name, path, status, or error",
  jobStateFilter: "State",
  jobKindFilter: "Operation",
  jobFilterAll: "All states",
  jobFilterActive: "Active",
  jobFilterAttention: "Needs attention",
  jobFilterFinished: "Finished",
  jobKindAll: "All operations",
  jobGroupActive: "Active",
  jobGroupAttention: "Needs attention",
  jobGroupFinished: "Finished",
  jobShowingCount: "Showing {shown} of {total}",
  noMatchingJobs: "No jobs match these filters.",
  ...
  dismissComparisonResult: "Delete saved comparison result",
  dismissComparisonResultTitle: "Delete comparison result?",
  deleteComparisonResult: "Delete result",
  dismissComparisonResultWarning:
  ...
  jobComparisonSourceChanged:
    "A comparison source changed while it was being read.",
  jobComparisonSourceChangedAction:
    "Wait until both sources are stable, then start the comparison again.",
...
const JAPANESE: Record<TranslationKey, string> = {
  ...
  comparison: "比較",
  comparisonDescription:
    "2つのアーカイブ、またはアーカイブとフォルダーを、どちらも変更せずに比較します。",
  comparisonJob: "比較",
  compareBaseline: "A — 基準",
  compareTarget: "B — 比較対象",
  archive: "アーカイブ",
  folder: "フォルダー",
  chooseA: "Aを選択",
  chooseB: "Bを選択",
  compareAAndB: "AとBを比較",
  startingComparison: "比較を開始しています…",
  comparisonStarted: "比較を開始しました",
  comparisonStartedHint: "読み取り専用の比較をジョブセンターに追加しました。",
  comparisonCompleted: "比較が完了しました",
  comparisonCompletedHint:
    "結果をここから表示できます。ジョブセンターにも保存されています。",
  comparisonDidNotComplete: "比較を完了できませんでした",
  comparisonDidNotCompleteHint:
    "下の詳細を確認するか、ジョブセンターから再試行してください。",
  comparisonReadOnlyHint:
    "どちらも読み取り専用です。比較によってアーカイブやフォルダーが変更されることはありません。",
  comparisonSourceRequired: "比較するAとBを選択してください。",
  comparisonSameSource: "異なる2つの対象を選択してください。",
  comparisonResults: "比較結果",
  viewComparisonResults: "比較結果を表示",
  allDifferences: "すべて",
  differenceAdded: "追加",
  differenceRemoved: "削除",
  differenceContentChanged: "内容変更",
  differenceMetadataChanged: "メタデータ変更",
  differenceSame: "同一",
  differenceUnavailable: "比較不可",
  differenceDetails: "差分の詳細",
  selectDifferenceHint: "項目を選択するとAとBの値を比較できます。",
  sourceA: "ソースA",
  sourceB: "ソースB",
  contentHash: "内容ハッシュ",
  metadataDifferences: "メタデータの差分",
  property: "項目",
  accessedAt: "アクセス日時",
  itemType: "種類",
  status: "状態",
  path: "パス",
  noDifferencesMatch: "この条件に一致する比較項目はありません。",
  comparisonSearchPlaceholder: "パスを検索",
  searchComparison: "比較結果を検索",
  comparisonLoadFailed: "比較結果を読み込めませんでした。",
  comparisonSourcePickerFailed: "比較する対象を選択できませんでした。",
  optionalArchivePassword:
    "任意 — 暗号化されたアーカイブの場合だけ入力します。",
  ...
  jobSearch: "ジョブを検索",
  jobSearchPlaceholder: "名前、パス、状態、エラー",
  jobStateFilter: "状態",
  jobKindFilter: "操作",
  jobFilterAll: "すべての状態",
  jobFilterActive: "処理中",
  jobFilterAttention: "要確認",
  jobFilterFinished: "終了",
  jobKindAll: "すべての操作",
  jobGroupActive: "処理中",
  jobGroupAttention: "要確認",
  jobGroupFinished: "終了",
  jobShowingCount: "{total}件中{shown}件を表示",
  noMatchingJobs: "条件に一致するジョブはありません。",
  showMoreJobs: "さらにジョブを表示",
  createJob: "アーカイブ作成",
  extractJob: "アーカイブ展開",
  appendJob: "アーカイブへ追加",
  deleteJob: "アーカイブから削除",
  ...
  dismissComparisonResult: "保存した比較結果を削除",
  dismissComparisonResultTitle: "比較結果を削除しますか？",
  deleteComparisonResult: "結果を削除",
  dismissComparisonResultWarning:
    "この比較結果を削除しますか？削除後は表示できません。",
  ...
  jobComparisonSourceChanged: "比較中に対象の内容が変更されました。",
  jobComparisonSourceChangedAction:
    "両方の対象への変更が完了してから、比較をもう一度開始してください。",
